...
export default function Dashboard() {
  ...
  function handleCreateNote(val) {
    setCreateNote(val);
  }

  return (
    <Box sx={{ height: "100vh", overflowY: "auto", boxSizing: "border-box" }}>
      {/* appbar */}
      ...
      <Grid2
        container
        sx={{ height: "calc(100vh - 67px)", boxSizing: "border-box" }}
      >
        ...
        <Grid2 size={{ xs: 6, md: 9.5 }} sx={{ padding: "16px 0" }}>
          <main className="h-full">
            {createNote ? (
              ...
              <NoNoteSelectedView handleCreateNote={handleCreateNote} />
            )}
          </main>
        </Grid2>
      </Grid2>
